...
### Let's check 1st file: /kaggle/input/Features data set.csv
...
### Let's check 2nd file: /kaggle/input/sales data-set.csv
nRowsRead = 1000 # specify 'None' if want to read whole file
...
### Let's check 3rd file: /kaggle/input/stores data-set.csv
nRowsRead = 1000 # specify 'None' if want to read whole file
